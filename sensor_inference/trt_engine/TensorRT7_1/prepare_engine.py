...
class PrepareBackend:
    def __init__(self, model, max_batch_size=1, build_fp16 = False,
        ...
        if use_DLA is True:
            ...
            for layer in self.network:
                # work around for image detection (jetpack4.4, 4.5 issue)
                layer_index = layer_index + 1
                if (layer_index < 181 and layer_index > 139) or layer_index < 40:
                    print('WARN: force set layer to GPU:', layer.name)

...
// gcc launch_rtsp_server.c -o launch_rtsp_server $(pkg-config --cflags --libs gstreamer-1.0 gstreamer-rtsp-server-1.0)
#include <gst/gst.h>
...
static char *mount_point = (char *) MOUNT_POINT;

static GOptionEntry entries[] = {
  {"port", 'p', 0, G_OPTION_ARG_STRING, &port,
      "Port to listen on (default: " DEFAULT_RTSP_PORT ")", "PORT"},
  {"mount", 'm', 0, G_OPTION_ARG_STRING, &mount_point,
      "Mount point (default: " MOUNT_POINT ")", "MOUNT"},
  {NULL}
};
...
main (int argc, char *argv[])
{
  ...
  g_object_set (server, "backlog", 1000, NULL);

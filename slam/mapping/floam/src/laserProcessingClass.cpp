...
void LaserProcessingClass::featureExtraction(const PointCloudAttrPtr& pc, pcl::PointCloud<pcl::PointXYZI>::Ptr& pc_out_edge, pcl::PointCloud<pcl::PointXYZI>::Ptr& pc_out_surf){
    ...
    for (int i = 0; i < (int) pc_in->points.size(); i++)
    {
        ...
        // else if (N_SCANS == 80)
        // {
        //     scanID = static_cast<int>(angle + 0.5);
        //     if (scanID > (N_SCANS - 1) || scanID < 0) {
        //         continue;
        //     }
        // }

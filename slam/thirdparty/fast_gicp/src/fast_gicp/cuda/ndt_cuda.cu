...
void NDTCudaCore::create_source_voxelmap() {
  ...
  covariance_regularization(source_voxelmap->voxel_means, source_voxelmap->voxel_covs, fast_gicp::RegularizationMethod::PLANE);
}
...
void NDTCudaCore::create_target_voxelmap() {
  ...
  covariance_regularization(target_voxelmap->voxel_means, target_voxelmap->voxel_covs, fast_gicp::RegularizationMethod::PLANE);
}

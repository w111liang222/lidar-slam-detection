...
const STEP_NAME = ["stepNameLidarImuBegin", "stepNameLidarImuCalib", "stepNameLidarImuCheck"];

const HELP_MESSAGE = ["helpMsgLidarImuBegin", "helpMsgLidarImuCalib", "helpMsgLidarImuCheck"];

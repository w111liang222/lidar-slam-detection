...
const STEP_NAME = ["stepNameSelectCamera", "stepNameCalibLidarAndCamera", "stepNameFinetune", "stepNameCheck"];

const HELP_MESSAGE = ["helpMsgSelectCamera", "helpMsgCalibLidarAndCamera", "helpMsgFinetune", "helpMsgCheck"];

...
/** A provider implements a communications modality for ZCM. (I.e., a
    URL handler.)

    The provider should call ZCM.receiveMessage() upon receipt of a
    message. ZCM.receiveMessage() is thread-safe and can be called from
    any thread.

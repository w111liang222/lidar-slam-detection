...
void CloudConvert::Process(const livox_ros_driver::CustomMsg::ConstPtr &msg, PointCloud::Ptr &pcl_out) {
    AviaHandler(msg);
    *pcl_out = cloud_out_;
}

void CloudConvert::Process(const sensor_msgs::PointCloud2::ConstPtr &msg, PointCloud::Ptr &pcl_out) {
    switch (lidar_type_) {
...
void CloudConvert::init(int lidar_type, int num_scans, double time_scale) {
